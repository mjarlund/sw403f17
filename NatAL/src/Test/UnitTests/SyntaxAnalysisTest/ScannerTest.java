...
public class ScannerTest {
	...
	public static class ErrorHandlingTests
	{
		...
		public void EmptyDocumentThrowsErrorTest() throws IOException
		{
			...
			try 
			{
				Scanner testScanner = new Scanner(InputTester.readFile("src/Test/TestPrograms/parserAndScanner/Testfail.txt"));
			} 
		...
		public void CharAsciiTestFail()
		{
			try
			{
				Scanner testScanner = new Scanner("void main()" + System.lineSeparator() + "character a is \'�\'" + System.lineSeparator() + "end main");
				while(true)
				{
					testScanner.NextToken();
				}
		...
		public void StringAsciiTestFail()
		{
			try
			{
				Scanner testScanner = new Scanner("void main()" + System.lineSeparator() + "string a is \"gj�gj\"" + System.lineSeparator() + "end main");
				while(true)
				{
					testScanner.NextToken();
				}
